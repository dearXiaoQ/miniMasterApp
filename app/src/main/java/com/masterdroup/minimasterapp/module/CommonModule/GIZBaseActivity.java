package com.masterdroup.minimasterapp.module.CommonModule;
...
public class GIZBaseActivity extends Activity {
	...
	public static void setBaseHandler(Handler basehandler) {
		if (null != basehandler) {
			GIZBaseActivity.baseHandler = basehandler;
		}
	...
	public void setActionBar(Boolean HBE, Boolean DSHE, int Title) {
		...
		ssTitle.setSpan(new ForegroundColorSpan(GIZDeploy.setNavigationBarTextColor()), 0, ssTitle.length(),
				Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
		actionBar = getActionBar();// 初始化ActionBar
		actionBar.setBackgroundDrawable(GIZDeploy.setNavigationBarColor());
