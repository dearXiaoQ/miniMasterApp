...
/**
 * Created by xiaoQ on 2017/5/26.
 */

class GizConfigModuleBaseActivity extends GIZBaseActivity{
    ...
    private GizWifiSDKListener gizWifiSDKListener = new GizWifiSDKListener() {
        ...
        public void didSetDeviceOnboarding(GizWifiErrorCode result, String mac, String did, String productKey) {
            GizConfigModuleBaseActivity.this.didSetDeviceOnboarding(result, mac, did, productKey);
        };
